...
export function ReassignPage() {
  ...
  return (
    <div className="narrow">
      ...
      <p className="muted">
        Transfers <strong>all</strong> companies and touchpoints owned by one committee member to
        another (end-of-year handover). Attribution (<code>created_by</code>) is preserved.
      </p>
      ...
      {run.data && (
        <p className="ok">
          Moved {run.data.companiesMoved} companies and {run.data.touchpointsMoved} touchpoints.
        </p>
      )}
      ...
      {confirming && (
        <div className="modal-backdrop" role="presentation" onClick={() => setConfirming(false)}>
          <div className="modal" role="dialog" aria-modal="true" onClick={(e) => e.stopPropagation()}>
            ...
            <p>
              This will move every company and touchpoint owned by the selected member. This cannot
              be undone automatically (though it is logged).
            </p>
            <div className="form-actions">
